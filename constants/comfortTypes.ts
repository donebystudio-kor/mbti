...
export const COMFORT_TYPES: ComfortType[] = [
  ...
  },
  {
    ...
    traits: ["현실적", "행동 지향", "막막함이 제일 힘듦", "방향 제시에 안도"],
  ...
  },
  {
    ...
    traits: ["존재감에 위로받음", "혼자 느낌이 제일 힘듦", "말보다 온도", "함께하는 시간"],
  ...
  },
  {
    ...
    traits: ["혼자만의 시간이 필수", "자기 회복력 강함", "강요받는 위로가 부담", "내버려두기 = 사랑"],
  ...
  },
  {
    ...
    traits: ["신뢰에 민감함", "응원에 에너지 충전", "믿어주는 사람이 원동력", "감동받기 쉬움"],
...
export const COMFORT_QUESTIONS: ComfortQuestion[] = [
  {
    ...
    emoji: "😮‍💨",
    options: [
      { text: "헐 왜? 무슨 일 있었어", type: "empathy" },
      { text: "어떻게 됐어? 같이 방법 생각해보자", type: "solution" },
      { text: "됐고 지금 나와 뭐라도 먹자", type: "distraction" },
    ],
  },
  {
    id: 2,
    ...
    options: [
      ...
      { text: "야 그래도 넌 진짜 잘하고 있는 거야", type: "cheer" },
    ],
  },
  {
    id: 3,
    ...
    options: [
      ...
      { text: "나 가도 돼? 그냥 옆에 있어줄게", type: "presence" },
      { text: "그렇구나.. 좀 혼자 있고 싶어?", type: "alone" },
    ],
  },
  {
    id: 4,
    ...
    emoji: "📉",
    options: [
      { text: "어떻게 됐는데? 같이 뭐가 문제인지 생각해보자", type: "solution" },
      { text: "오늘은 그냥 잊어버려 우리 뭔가 재밌는 거 하러 가자", type: "distraction" },
      { text: "야 그래도 네가 열심히 한 거 나 알아 분명히 될 거야", type: "cheer" },
    ],
  },
  {
    id: 5,
    ...
    options: [
      ...
      { text: "야 그래도 넌 진짜 잘 버티고 있어 알아?", type: "cheer" },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "야 지금 당장 카페 가자 거기서 얘기해", type: "distraction" },
    ],
  },
  {
    id: 7,
  ...
  },
  {
    ...
    emoji: "🛋️",
    options: [
      { text: "야 그냥 나와 밖에 있으면 더 나을 거야", type: "distraction" },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "앞으로 어떻게 할지 같이 생각해봤어?", type: "solution" },
    ],
  },
  {
    id: 10,
    ...
    options: [
      ...
      { text: "그러면 더 힘들어 우리 뭔가 하러 나가자", type: "distraction" },
  ...
  {
    id: 12,
    myMessage: "앞으로 어떻게 해야 하지",
    emoji: "🔭",
    options: [
      { text: "같이 생각해보자 일단 뭐부터 하면 좋을지", type: "solution" },
      { text: "야 일단 지금 그 생각 끊고 뭔가 하러 가자", type: "distraction" },
